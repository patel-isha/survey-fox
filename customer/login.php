...
<body>
    ...
    <div class="splash-container ">
        <div class="card colBlack">
            <div class="card-header text-center"><a href="../index.php"><img class="logo-img" src="../assets/img/logo/logo-blue.png" alt="logo" width="150px"></a><span class="splash-description">Customer Portal</span></div>
            <div class="card-body">
            ...
            <div class="card-footer bg-white p-0  ">
                <div class="card-footer-item card-footer-item-bordered">
                    <a href="register-customer.php" class="footer-link">Create An Account</a></div>
                <div class="card-footer-item card-footer-item-bordered">
