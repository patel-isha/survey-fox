                    ...
                    <div class="row">
                        <div class="col-md-12 mx-0">
                            <form id="msform">
                                ...
                                <h3 class="navy-blue"><strong><?php echo $sur_row['Name']; ?> <span
                                            class="light-blue">Survey</span></strong></h3>
                                <!-- fieldsets -->
                                <fieldset name="step0">
                                    <div class="form-card text-center pb-0">
                                        <div class="typewriter mb-3">
                                            <h4 class="tagline mb-2 line1">Your answers matters for the company.</h4>
                                            <h4 class="tagline light-blue line2 mb-2 hidden">Start Your Journey Now!
                                            </h4>
                                        </div>
                                ...
                                <fieldset name="step2">
                                    ...
                                    <input type="button" name="previous" class="previous action-button-previous"
                                        value="Previous" />
                                    <input type="button" name="next" onclick="saveDataAndSend('step2');"
                                ...
                                <fieldset name="step3">
                                    <div class="form-card">
                                        ...
                                        <div class="mb-30">
                                            ...
                                            <div class="radio">
                                                <label><input type="radio" name="optQArating" value="Excellent"
                                    ...
                                    <input type="button" name="previous" class="previous action-button-previous"
                                        value="Previous" />
                                    <input type="button" name="next" onclick="saveDataAndSend('step3');"
                                        class="next action-button" value="Next" />
                                </fieldset>
                                <fieldset name="step4">
                                    <div class="form-card">
                                        ...
                                        <div class="mb-30">
                                            ...
                                            <div class="radio">
                                                <label><input type="radio" name="optRatings" value="Excellent"
                                        ...
                                        <div class="mb-30">
                                            ...
                                            <div class="radio">
                                                <label><input type="radio" name="optInfo" value="Email newsletters"
                                                        qid="31">Email newsletters</label>
                                            </div>
                                            <div class="radio">
                                                <label><input type="radio" name="optInfo" value="Social media"
                                                        qid="31">Social media</label>
                                            </div>
                                            <div class="radio">
                                                <label><input type="radio" name="optInfo" value="Website"
